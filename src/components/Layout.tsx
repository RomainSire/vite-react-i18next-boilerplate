        ...
        <div className="flex flex-col min-h-screen bg-gray-100 gap-10 p-8">
            <header>
                <nav>
                    <ul>
                        <li>
                            <NavLink className={handleActiveClasses} to={`/${lang}`} end>
                                {t("home.short_title")}
                            </NavLink>
                        </li>
                        <li>
                            <NavLink className={handleActiveClasses} to={`/${lang}/about`}>
                                {t("about.short_title")}
                            </NavLink>
                        </li>
                        <li>
                            <NavLink className={handleActiveClasses} to={`/${lang}/contact`}>
